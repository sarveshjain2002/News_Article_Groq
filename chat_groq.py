...
st.title("Groq's AI: Revolutionizing News ArticleMaker")
...
# Set assistant_type in session state
    ...
    write_article = st.button("Generate Article")
    if write_article:
        news_results = []
    ...
    st.sidebar.markdown(""" 
        ...
        <footer style="text-align:center; color: #7f8c8d;">
            <p>Powered by OpenAI and Google Gemini | © 2024 Sarvesh Udapurkar</p>
        </footer>
